...
const ServiceProviderService = {
  async createServiceProvider(serviceProviderData) {
    ...
    return await ServiceProviderRepository.createServiceProvider(
      serviceProviderData
    );
  },

  async getServiceProviderById(serviceProviderId) {
    return await ServiceProviderRepository.getServiceProviderById(
      serviceProviderId
    );
  },

  async updateServiceProvider(serviceProviderId, updatedData) {
    return await ServiceProviderRepository.updateServiceProvider(
      serviceProviderId,
      updatedData
    );
  },
  ...
  async deleteServiceProvider(serviceProviderId) {
    ...
    return await ServiceProviderRepository.deleteServiceProvider(
      serviceProviderId
    );
  },
